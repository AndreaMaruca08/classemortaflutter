...
class Achievmentpage extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                if (posAchievments.isNotEmpty)
                  ...
                  spacing: 8.0,
                  runSpacing: 8.0,
                  children: posAchievments.map((achievment) => displayAchievement(achievment, screenSize.width)).toList(),
                ),
                const SizedBox(height: 10),
                ...
                Wrap(
                  ...
                  children: negAchievments.map((achievment) {
                    return displayAchievement(achievment, screenSize.width);
                  }).toList(),
                ),
                const SizedBox(height: 10,),
  ...
  Widget displayAchievement(Achievment achievment, double screenSize){
