...
class _MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    _lastVotiFuture = _service.getLastVoti();
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                if (loadedMedie.length > 0) VotoSingolo(voto: loadedMedie[0], grandezza: 115),
                ...
                const Text("Ultimi 10 voti", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Agenda(apiService: _service)), // Sostituisci con la tua pagina
                              );
                            },
                            icon: Icon(Icons.accessible_forward_outlined),
                            tooltip: 'Agenda',
                          ),
                          Text("Agenda|Compiti|Verifiche")
                        ],
                      ),
                    )
